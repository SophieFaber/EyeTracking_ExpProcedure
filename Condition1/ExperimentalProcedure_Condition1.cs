...
public class ExperimentalProcedure_Condition1 : MonoBehaviour
{
    ...
    public HTCTracker_Condition1 rightFootTracker; 
    public HTCTracker_Condition1 leftFootTracker; 
    ...
    private void UpdateStepmarkVisibility()
    {
        ...
        HTCTracker_Condition1 relevantTracker = currentStepmarkIndex % 2 == 0 ? rightFootTracker : leftFootTracker; 
